...
fs.writeFileSync('packages/core/src/compliance/office-ecd-sped-generation-engine.ts', code.trim() + '\n', 'utf8');
console.log('Fixed currency formatting in office-ecd-sped-generation-engine.ts');
