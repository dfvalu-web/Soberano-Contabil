...
fs.writeFileSync('packages/core/src/tax/special-sectors/agribusiness-cpc29-lcdpr.ts', Buffer.from(b64, 'base64').toString('utf8'), 'utf8');
console.log('Written agribusiness-cpc29-lcdpr.ts cleanly.');
