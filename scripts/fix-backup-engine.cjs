...
fs.writeFileSync('packages/core/src/security/encrypted-backup-engine.ts', Buffer.from(b64, 'base64').toString('utf8'), 'utf8');
console.log('Fixed encrypted-backup-engine.ts to use SecurityEngine methods.');
