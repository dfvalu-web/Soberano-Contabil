const fs = require('fs');
const content = `import { SpedRecord } from '../../types/sped.js';
...
`;
fs.writeFileSync('packages/core/src/sped/formatter/sped-writer.ts', content, 'utf8');
console.log('Fixed sped-writer.ts');
