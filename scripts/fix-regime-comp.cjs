...
const code = `import { calculateSimplesNacional } from '../simples-nacional/calculator.js';
...
fs.writeFileSync('packages/core/src/tax/diagnostic/regime-comparator.ts', code, 'utf8');
console.log('Fixed regime-comparator properties.');
