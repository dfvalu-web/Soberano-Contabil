...
const cryptoCode = `import * as nodeCrypto from 'crypto';
...
fs.writeFileSync('packages/core/src/security/crypto.ts', cryptoCode, 'utf8');
console.log('Made crypto.ts isomorphic and browser-safe.');
