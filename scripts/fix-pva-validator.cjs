const fs = require('fs');
const content = `import { SpedType, SpedValidationReport, SpedValidationIssue } from '../../types/sped.js';
...
`;
fs.writeFileSync('packages/core/src/sped/validator/pva-validator.ts', content, 'utf8');
console.log('Fixed pva-validator.ts');
